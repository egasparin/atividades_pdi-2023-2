...
class ImageConverterApp(QMainWindow):
    ...
    def show_image(self, name, image, use_hsv_split=False):
        ...
        if not pixmap.isNull():
            ...
            label.setGeometry(10, 10, pixmap.width(), pixmap.height())  # Defina a geometria do QLabel

            # Redimensione a janela para caber na imagem
            window.resize(pixmap.width() + 20, pixmap.height() + 20)
